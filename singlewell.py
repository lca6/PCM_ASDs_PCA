# This file loads in Raman spectra taken manually from a single well

# To read the files, they must be in the format [row][column]_[year][month][day]_PCM_[two-digit plate number].txt
